...
MobileFuel.MapController = M.Controller.extend({
    ...
    onSuccess: function(location) {
        ...
        MobileFuel.RequestController.getStationList(this.location);
    },
    ...
    markerClicked: function(marker) {
        ...
        if(marker) {
            ...
            MobileFuel.LocationSearchDetailController.set('stationId', marker.data.record.id);
            console.log(MobileFuel.LocationSearchDetailController.stationId);
            MobileFuel.RequestController.getStationFuels(marker.data.record.id);
        }
    }
