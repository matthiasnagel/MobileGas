...
MobileTank.MapController = M.Controller.extend({
    ...
    onSuccess: function(location) {
        ...
        MobileTank.RequestController.getStationList(this.location);
    },
    ...
    markerClicked: function(marker) {
        ...
        if(marker) {
            ...
            MobileTank.LocationSearchDetailController.set('stationId', marker.data.record.id);
            console.log(MobileTank.LocationSearchDetailController.stationId);
            MobileTank.RequestController.getStationFuels(marker.data.record.id);
        }
    }
